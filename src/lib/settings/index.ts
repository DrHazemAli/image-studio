 ...
 */
export function config(key: string, value?: any, storage?: StorageType, encrypted?: boolean): any {
  if (value === undefined) {
    // Get mode
 ...
 */
export function configMigrate(key: string, fromStorage: StorageType, toStorage: StorageType, removeFromSource: boolean = true): boolean {

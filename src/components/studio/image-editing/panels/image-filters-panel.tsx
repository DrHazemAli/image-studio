...
export const ImageFiltersPanel: React.FC<ImageFiltersPanelProps> = ({
  ...
  return (
    <SlidingPanel
      ...
      onClose={onClose}
      title="Image Filters"
      icon={<MixerHorizontalIcon className="w-5 h-5 text-blue-600 dark:text-blue-400" />}
      width="xl"
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          >
            <Collapsible.Trigger asChild>
              <button className="flex items-center justify-between w-full p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                <span className="font-medium text-gray-900 dark:text-white">Effects</span>
                  ...
                  >
                    <div className="pt-4 space-y-4">
                      ...
                      <AdjustmentSlider
                        ...
                        onChange={(value) => handleAdjustmentChange('sepia', value)}
                        min={0}
                        max={100}
                        defaultValue={0}
                        unit="%"
                      ...
                      <AdjustmentSlider
                        ...
                        onChange={(value) => handleAdjustmentChange('grayscale', value)}
                        min={0}
                        max={100}
                        defaultValue={0}
                        unit="%"

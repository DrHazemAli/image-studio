...
export default function LayerManager({
  ...
  const createLayerSelectHandler = useCallback((layerId: string) => {
    return () => onLayerSelect(layerId);
  }, [onLayerSelect]);

  const createLayerVisibilityHandler = useCallback((layerId: string) => {
  ...
  const createLayerLockHandler = useCallback((layerId: string) => {
    return (e: React.MouseEvent) => {
      e.stopPropagation();
  ...
  const createLayerDuplicateHandler = useCallback((layerId: string) => {
    return (e: React.MouseEvent) => {
      e.stopPropagation();
  ...
  const createLayerDeleteHandler = useCallback((layerId: string) => {
    return (e: React.MouseEvent) => {
      e.stopPropagation();
  ...
  const createLayerOpacityHandler = useCallback((layerId: string) => {

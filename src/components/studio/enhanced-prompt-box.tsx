...
export default function EnhancedPromptBox({
  ...
  const handleProgrammaticTextChange = useCallback(
    (newText: string) => {
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative mt-1" id="attach-button-container">
                <motion.div
              ...
              >
                <Badge
                  variant="surface"
                  className="hidden lg:block bg-gray-100/50 dark:bg-gray-800/50 text-gray-600 dark:text-gray-400 !rounded-lg px-3 py-1 shadow-sm"
                >
                  {count}x
                </Badge>
              </motion.div>
              ...
              {isInpaintMode && (
                ...
                >
                  <Badge
                    variant="outline"
                    color="orange"
                    className="hidden lg:block !rounded-lg px-3 py-1 shadow-sm"
                  >
                    EDIT
                  </Badge>
                </motion.div>
                ...
                {isInpaintMode ? (
                  <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <div>
                      ...
                      <ul className="space-y-1 text-xs list-disc list-inside pl-2">
                        <li>
                          <strong>FLUX.1 Kontext Pro</strong> - Primary editing
                          model (8x faster)
                        </li>
                        <li>
                          <strong>GPT-image-1</strong> - Precise edits and
                          modifications
                        </li>
                        <li>
                          <strong>Florence 2.0</strong> - Background removal &
                          segmentation
                        </li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-1 text-xs list-disc list-inside pl-2">
                        ...
                        <li>
                          Use &ldquo;replace X with Y&rdquo; for clear
                          instructions
                        </li>
                        <li>
                          Try &ldquo;remove the background&rdquo; with Florence
                          2.0
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <div>
                      ...
                      <ul className="space-y-1 text-xs list-disc list-inside pl-2">
                        <li>
                          <kbd>Enter</kbd> - Generate image
                        </li>
                        <li>
                          <kbd>Shift+Enter</kbd> - New line
                        </li>
                        <li>
                          <kbd>I</kbd> - Toggle inpaint mode
                        </li>
                      </ul>
                    </div>
                  </div>

...
export const AboutModal = React.memo<AboutModalProps>(({ isOpen, onClose }) => {
  return (
    <BaseModal
      ...
      icon={
        <InfoCircledIcon className="w-5 h-5 text-blue-600 dark:text-blue-400" />
      }
      size="md"
    >
      <div className="space-y-6">
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4">
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            {appConfig.app.description}. Create stunning images, apply advanced
            filters, and manipulate your creations with professional-grade
            tools.
          </p>
        </div>
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Principal AI & ML Engineer / Architect | Speaker | Founder &
                  CEO of Skytells
                </p>
              </div>
            </div>

...
_Extending and customizing Image Studio for your needs_
...
This guide provides comprehensive information for developers who want to extend, customize, or contribute to Image Studio. Learn about the codebase structure, development workflows, and how to create custom features and integrations.
...
```bash
# .env.local
NEXT_PUBLIC_APP_NAME="Image Studio"

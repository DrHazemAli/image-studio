...
Learn how to add, configure, and manage AI models in Azure Image Studio. This comprehensive guide covers everything from adding models through the settings UI to advanced configuration and validation.

**Last Updated**: September 2025

## 🎯 Overview

Azure Image Studio supports multiple AI model providers and allows you to add custom models, configure their settings, and validate their functionality. This guide will walk you through the entire process of adding and managing models.
...
- ✅ **Azure Configuration**: Valid Azure API key and endpoint configured
- ✅ **Model Access**: Access to the AI models you want to add
- ✅ **Deployment Names**: Correct deployment names for your Azure resources
- ✅ **API Versions**: Compatible API versions for your models

## 🔧 Adding Models Through Settings UI
...
- 🟢 **Valid**: Model is properly configured and accessible
- 🔴 **Invalid**: Model has configuration issues or is not accessible
...
- [Model Sharing Forum](https://forum.azure-image-studio.com)

### Tools and Utilities

- [Model Configuration Validator](https://validator.azure-image-studio.com)
- [Azure Model Catalog](https://catalog.azure.com)
- [Configuration Templates](https://templates.azure-image-studio.com)
...
[← Back: Settings Guide](settings-guide.mdx) | [Next: Troubleshooting Guide →](troubleshooting-guide.mdx)

</div>

---

This guide provides comprehensive coverage of adding and managing models in Azure Image Studio. For more information, see the [Settings Guide](settings-guide.mdx) or [Azure Setup Guide](azure-setup-guide.mdx).

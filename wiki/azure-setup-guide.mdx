# Image Studio - Complete Azure Setup & Configuration Guide
...
Image Studio uses a token-based authentication system with the following components:
...
Before configuring Image Studio, ensure you have:
...
### 3.1 Accessing Settings in Image Studio

#### Step 1: Application Login

1. Start Image Studio application
...
Image Studio supports multiple Azure endpoints for load balancing and redundancy:
...
The Image Studio supports multiple AI models for different use cases:
...
Image Studio includes advanced data synchronization capabilities:
...
Image Studio supports sophisticated endpoint management for enterprise environments:
...
2. Update deployment name in Image Studio settings
...
This comprehensive guide provides all the necessary information to successfully configure and deploy Image Studio with Azure services. The application leverages cutting-edge AI models from Azure OpenAI and Azure AI Foundry to deliver professional-grade image generation capabilities.
...
_This guide is part of the Image Studio documentation suite. For more guides and tutorials, visit the [wiki directory](.)._

**Document Version:** 1.0.1  
**Last Updated:** September 10, 2025  
**Compatibility:** Image Studio v1.0.1+

# AI Image Studio - Complete Azure Setup & Configuration Guide
...
**Repository:** [https://github.com/DrHazemAli/image-studio](https://github.com/DrHazemAli/image-studio)  
...
AI Image Studio uses a token-based authentication system with the following components:
...
Before configuring AI Image Studio, ensure you have:
...
4. Configure the resource:
   ...
   Resource Group: rg-image-studio
...
3. Create a new project:
   ```
   Project Name: image-studio-models
   Resource Group: rg-image-studio
   Location: East US
   ```
...
```bash
# Using Azure CLI
az group create --name rg-image-studio --location eastus
```
...
az ad sp create-for-rbac --name "image-studio-sp" \
    --role "Cognitive Services Contributor" \
    --scopes /subscriptions/{subscription-id}/resourceGroups/rg-image-studio

# Output example:
{
  "appId": "12345678-1234-1234-1234-123456789012",
  "displayName": "image-studio-sp",
...
### 3.1 Accessing Settings in AI Image Studio

#### Step 1: Application Login

1. Start AI Image Studio application
...
AI Image Studio supports multiple Azure endpoints for load balancing and redundancy:
...
async function validateAzureConfig(config: AzureConfig) {
  ...
  // 2. Validate API key
  const authTest = await validateApiKey(
...
The AI Image Studio supports multiple AI models for different use cases:
...
AI Image Studio includes advanced data synchronization capabilities:
...
AI Image Studio supports sophisticated endpoint management for enterprise environments:
...
2. Update deployment name in AI Image Studio settings
...
This comprehensive guide provides all the necessary information to successfully configure and deploy AI Image Studio with Azure services. The application leverages cutting-edge AI models from Azure OpenAI and Azure AI Foundry to deliver professional-grade image generation capabilities.
...
- **GitHub Repository:** [https://github.com/DrHazemAli/image-studio](https://github.com/DrHazemAli/image-studio)
...
_This guide is part of the AI Image Studio documentation suite. For more guides and tutorials, visit the [wiki directory](.)._

**Document Version:** 1.0.1  
**Last Updated:** September 10, 2025  
**Compatibility:** AI Image Studio v1.0.1+

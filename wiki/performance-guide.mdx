...
*Get the best performance from your Azure Image Studio setup*
...
This guide provides comprehensive strategies for optimizing Azure Image Studio's performance across different hardware configurations and use cases. Learn how to maximize generation speed, minimize resource usage, and ensure smooth operation.
...
2. **CPU Affinity:**
   ...
   sudo nice -n -10 azure-image-studio
   ```
...
azure-image-studio dev monitor

# Check specific metrics
azure-image-studio dev monitor --metric memory
azure-image-studio dev monitor --metric cpu
azure-image-studio dev monitor --metric network
```
...
export DEBUG=azure-image-studio:performance

# Run with performance profiling
azure-image-studio dev profile

# Generate performance report
azure-image-studio dev report --performance
```

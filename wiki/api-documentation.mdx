...
*Complete API reference for Azure Image Studio's REST endpoints*
...
Azure Image Studio provides a comprehensive REST API built on Next.js App Router, offering endpoints for image generation, asset management, configuration, and authentication. All endpoints are designed to work seamlessly with the web interface and CLI tools.
